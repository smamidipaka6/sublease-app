      ...
      <Box sx={{ paddingTop: "8px" }}>
        <Grid container spacing={0} sx={{ border: "" }}>
          ...
          >
            ...
            >
              <Grid item>
                <PeopleAttribute text="1"></PeopleAttribute>
              </Grid>
              <Grid item>
                <SizeAttribute text="3x2"></SizeAttribute>
              </Grid>
              <Grid item>
                <MaleGenderAttribute text="Female"></MaleGenderAttribute>
              </Grid>
            </Grid>
          </Grid>
          <Grid
          ...
          >
            <GroupTypography>
              <div style={{ textAlign: "left" }}>
                &bull; I, Sarah, am an easygoing roommate who loves decorating
                the apartment and often hosts small gatherings.
                <br />
              </div>
            </GroupTypography>
          </Grid>
